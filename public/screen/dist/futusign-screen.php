...
<body>
  ...
  <?php endwhile; ?>
  <!-- MANUALLY UPDATE -->
  <script src="<?php echo plugins_url( 'vendor.2715aa94a6ffa8a2f707.bundle.js', __FILE__ ); ?>"></script>
  <!-- MANUALLY UPDATE -->
  <script src="<?php echo plugins_url( 'main.10898d6c95472288155f.bundle.js', __FILE__ ); ?>"></script>
</body>
</html>
