...
<body>
  ...
  <?php endwhile; ?>
  <!-- MANUALLY UPDATE -->
  <script src="<?php echo plugins_url( 'vendor.7aa670bbb5cdc75794ae.bundle.js', __FILE__ ); ?>"></script>
  <!-- MANUALLY UPDATE -->
  <script src="<?php echo plugins_url( 'main.b4361fc4edb6b1db122c.bundle.js', __FILE__ ); ?>"></script>
</body>
</html>
